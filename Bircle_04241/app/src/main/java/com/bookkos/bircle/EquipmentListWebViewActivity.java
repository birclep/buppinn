...
public class EquipmentListWebViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        HttpPost post = new HttpPost(BircleTools.BircleHome+"/equipment/show");
...
//		webView.loadUrl("https://bms-dev.herokuapp.com");
        webView.postUrl(BircleTools.BircleHome+"/equipment/show", EncodingUtils.getBytes(postData, "UTF-8"));
    }
    @Override
    public void onPause() {
        super.onPause();
