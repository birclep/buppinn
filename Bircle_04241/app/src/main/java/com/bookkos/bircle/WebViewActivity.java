...
public class WebViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		HttpPost post = new HttpPost(BircleTools.BircleHome+"/session");
		
		ArrayList<NameValuePair> value = new ArrayList<NameValuePair>();
		
		String postData = "login_id=" + loginId + "&password=" + secret + "&group_id=" + groupId;
...
//		webView.loadUrl("https://bms-dev.herokuapp.com");
		webView.postUrl(BircleTools.BircleHome+"/session", EncodingUtils.getBytes(postData, "UTF-8"));
	}
